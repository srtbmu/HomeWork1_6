...
class Adapter(private var onLongClick: (position: TaskModel) -> Unit,private var checkedTask:(TaskModel,Boolean)->Unit): Adapter<com.example.hw_1_6.ui.task.adapter.Adapter.TaskHolder>() {
